...
public class DemonMonster extends Monster {
  ...
  protected void generateAnimations() {
    ...
    String[] hitLeftFrames = new String[] {"tileset/demon/big_demon_idle_left_anim_f0_hit.png"};
    hitAnimationLeft = createAnimation(hitLeftFrames, 1);

    String[] hitRightFrames = new String[] {"tileset/demon/big_demon_idle_anim_f0_hit.png"};
