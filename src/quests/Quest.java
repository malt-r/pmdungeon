...
public abstract class Quest implements IObservableQuest {
    ...
    /**
     * Flag to check, if the reward can be retrieved from this quest -> will be set to false in cleanup
     */
    ...
    /**
     * Initial setup of the quest (this is the place to register the quest as an observer where necessary)
     */
