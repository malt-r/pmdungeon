...
public class SpatialHashMapEntry {
    ...
    /**
     * Constructor.
     * @param key The key associated with this entry (The floored point of entities, which will be stored in this entry)
    ...
    /**
     * Add a new DrawableEntity to the stored values. Will perform a check, if the Entity is already stored in the values.
