...
/**
 * A stat-attribute. Stores a base value and modifiers, which will be
 * either multiplied or added to the base value to calculate the effective
 * attribute value.
 */
public class Attribute {
    ...
    /**
     * Sets the effective Value of this attribute. Only applicable for
     * Type HEALTH.
