 ...
 * Wood Shield.
 *
 * <p>Contains everything that describes a Wood shield.
 */
public class WoodShield extends Shield {
  ...
  public WoodShield() {
    ...
    this.modifiers.add(
        new Modifier(
            1.1f, Modifier.ModifierType.MULTIPLIER, Attribute.AttributeType.EVASION_CHANCE));
    String[] idleLeftFrames = new String[] {"tileset/items/shield_wood.png"};
