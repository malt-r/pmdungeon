 ...
 * Regular sword class.
 *
 * <p>Contains everything that describes a golden sword.
 */
public class GoldenSword extends Weapon {
  ...
  public GoldenSword() {
    ...
    this.modifiers.add(
        new Modifier(
            2.f, Modifier.ModifierType.MULTIPLIER, Attribute.AttributeType.PHYSICAL_ATTACK_DAMAGE));
    this.modifiers.add(
        new Modifier(0.7f, Modifier.ModifierType.MULTIPLIER, Attribute.AttributeType.HIT_CHANCE));
    this.range = 1.0f;
    this.condition = 100;
    String[] idleLeftFrames = new String[] {"tileset/items/weapon_golden_sword.png"};
